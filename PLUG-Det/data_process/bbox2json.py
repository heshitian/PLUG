...
ref_json_file = '/media/h/H/DOTA10_512_128/annotations/DOTA_train_512.json'
result_json_file = os.path.join(meta_dir, 'DOTA_train_512.json')
ref_json = mmcv.load(ref_json_file)
bbox_all = mmcv.load(bbox_json_file)
for id, bbox_info in enumerate(bbox_all):

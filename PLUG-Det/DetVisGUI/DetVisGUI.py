...
out_meta = '/media/h/M/P2B/1dota/boxinst_r50/'
def parse_args():
    parser = argparse.ArgumentParser(description='DetVisGUI')

    parser.add_argument('--config',  default=out_meta + '/boxinst_r50_caffe_fpn_dota_1x.py',help='config file path')
    parser.add_argument('--det_file', 
    	default= out_meta + '/val/result.pkl',
    ...
    parser.add_argument('--output', default=out_meta + '/val/output/', help='image save folder')
...
class vis_tool:
    ...
    def __init__(self):
        ...
        elif cfg.dataset_type == 'DOTADataset':
            self.data_info = DOTA_dataset(cfg, self.args)
        elif cfg.dataset_type == 'CocoCPDataset':
            self.data_info = COCO_dataset(cfg, self.args)

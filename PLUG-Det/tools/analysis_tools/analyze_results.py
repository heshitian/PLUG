...
def parse_args():
    ...
    parser.add_argument('--config', default = '/media/h/M/P2B/1211/mine_stride8_gtnegcolorgtlow/cascade_CPR_r50_FPN_1x_DOTA_512_loss.py',help='test config file path')
    parser.add_argument(
        '--prediction_path', default = '/media/h/M/P2B/1211/mine_stride8_gtnegcolorgtlow/result.pkl', help='prediction path where test pkl result')
    parser.add_argument(
        '--show_dir',default='/media/h/M/P2B/1211/mine_stride8_gtnegcolorgtlow/', help='directory where painted images will be saved')
    parser.add_argument('--show', action='store_true', default=False, help='show results')
    parser.add_argument('--show_score_thr', default=0.5, help='show results')
    parser.add_argument(
        '--wait-time',
        type=float,
        default=0,
...
def main():
    ...
    cfg.data.test.pipeline = get_loading_pipeline(cfg.data.train.pipeline) # change by H cfg.data.train.dataset.pipeline

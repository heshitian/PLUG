...
def main():
    ...
    parser.add_argument('--result',default='/media/h/M/dataset/AITOD/work_dirs/centernet/results_val1.bbox.json',  help='result file (json format) path')
    parser.add_argument('--out_dir', default='/media/h/M/dataset/AITOD/work_dirs/centernet/result/', help='dir to save analyze result images')
    parser.add_argument(
        '--ann',
        default='/media/h/M/dataset/AITOD/annotations/aitod_test_v1.json',

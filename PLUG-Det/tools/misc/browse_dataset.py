...
def parse_args():
    ...
    parser.add_argument('--config', default = '/media/h/M/P2B/1dota/mask_rcnn_r50/mask_rcnn_r50_fpn_1x_dota_c.py', help='train config file path')
    parser.add_argument(
        '--skip-type',
        type=str,
        nargs='+',
    ...
    parser.add_argument(
        '--output-dir',
        default='/media/h/H/DOTA10_512_128/val/images_with_anns/',
        type=str,

...
from mmdet.core.visualization import imshow_det_bboxes, imshow_bboxes_points
from mmdet.datasets.builder import build_dataset


def parse_args():
    parser = argparse.ArgumentParser(description='Browse a dataset')
    parser.add_argument('--config', default = '/media/h/M/P2B/1dota/visual/between_class/nofuse_r0_visual/cascade_CPR_r50_FPN_1x_DOTA_512_trm.py', help='train config file path')
    parser.add_argument(
        '--skip-type',
        type=str,
        nargs='+',
    ...
    parser.add_argument(
        '--output-dir',
        default='/media/h/M/P2B/1dota/visual/between_class/ann/',
        type=str,
...
def main():
    ...
    for item in dataset:
        ...
        print(item['filename'])
        gt_bboxes = item['gt_bboxes'] # change by H gt_true_bboxes, gt_bboxes
        pseudo_bboxes =  item['gt_pseudo_bboxes'] 

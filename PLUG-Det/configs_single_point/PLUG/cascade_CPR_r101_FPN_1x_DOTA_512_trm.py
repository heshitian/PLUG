...
data = dict(
    ...
    test=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + '/annotations/DOTA_val_512_coarse.json',
        # ann_file=data_root + '/annotations/DOTA_train_512_center.json',
...
model=dict(
    type='BasicLocator',
    pretrained='/home/h/checkpoints/resnet101-5d3b4d8f.pth',
    backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
...
work_dir = '/media/h/M/P2B/1dota/fuse_r0_res101/'
